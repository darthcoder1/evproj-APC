...
typedef struct
{
    ...
    uint32_t s2 : 1;
    uint32_t s3 : 1;
} OutputDiagChannelSelector_t;

static const OutputDiagChannelSelector_t g_outputDiagChannelSelector[] = {
    { .s0 = 0, .s1 = 1, .s2 = 1, .s3 = 1 }, // Y7  -> Channel 0
    { .s0 = 0, .s1 = 1, .s2 = 1, .s3 = 0 }, // Y6  -> Channel 1
    { .s0 = 0, .s1 = 1, .s2 = 0, .s3 = 1 }, // Y5  -> Channel 2
    { .s0 = 0, .s1 = 1, .s2 = 0, .s3 = 0 }, // Y4  -> Channel 3
    { .s0 = 0, .s1 = 0, .s2 = 1, .s3 = 1 }, // Y3  -> Channel 4
    { .s0 = 0, .s1 = 0, .s2 = 1, .s3 = 0 }, // Y2  -> Channel 5
    { .s0 = 1, .s1 = 0, .s2 = 0, .s3 = 0 }, // Y8  -> Channel 6
    { .s0 = 1, .s1 = 0, .s2 = 0, .s3 = 1 }, // Y9  -> Channel 7
    { .s0 = 1, .s1 = 0, .s2 = 1, .s3 = 0 }, // Y10 -> Channel 8
    { .s0 = 1, .s1 = 0, .s2 = 1, .s3 = 1 }, // Y11 -> Channel 9
    { .s0 = 1, .s1 = 1, .s2 = 0, .s3 = 0 }, // Y12 -> Channel 10
    { .s0 = 1, .s1 = 1, .s2 = 0, .s3 = 1 }, // Y13 -> Channel 11
};
...
static const PinMapEntry_t g_PinMapping[] = {
    ...
    { .gpio = GPIOB, .pin = GPIO_PIN_9 }, // Pin_Output_Diag_Data,
    { .gpio = GPIOB, .pin = GPIO_PIN_8 }, // Pin_Outout_Diag_S0,
